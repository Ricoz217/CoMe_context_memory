...
DEFAULTS: dict[str, Any] = {
    ...
    "llm_presets": {
        "CONTEXT_MEMORY": {
            "endpoint": os.getenv("OPENAI_API_ENDPOINT", "https://api.deepseek.com/chat/completions"),
        ...
        "KIMI2.6": {
            "endpoint": os.getenv("OPENAI_API_ENDPOINT", "https://api.siliconflow.cn/v1/chat/completions"),
            "token": os.getenv("OPENAI_API_KEY", ""),
            "model": os.getenv("OPENAI_MODEL", "Pro/moonshotai/Kimi-K2.6"),
            "api_type": "openai",
            "max_context": 256_000,
            "auto_compress_gate": 0.7,
            "extra_parameter": {},
